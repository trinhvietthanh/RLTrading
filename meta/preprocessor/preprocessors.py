...
class FeatureEngineer:
    ...
    def clean_data(self, data):
        ...
        check_list_have_nan = merged_closes[merged_closes.isna().any(axis=1)]
        list_date = np.array(check_list_have_nan.index)
        

        
        df = df.drop(df[(df['date'].isin(list_date))].index)
    ...
    def add_technical_indicator(self, data):
        ...
        print("TIC: ", data)
        print("TICKER:: ",unique_ticker)
        print("INCATOR:: ",self.tech_indicator_list)
