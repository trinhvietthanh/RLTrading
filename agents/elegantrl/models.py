import torch
from elegantrl.agents import AgentA2C, AgentPPO, AgentDDPG, AgentTD3
from elegantrl.train.config import Arguments
from elegantrl.train.run import init_agent
from elegantrl.train.run import train_and_evaluate

MODELS = {"ddpg": AgentDDPG, "td3": AgentTD3, "a2c": AgentA2C, "ppo": AgentPPO}
OFF_POLICY_MODELS = ["ddpg", "td3", "a2c"]
